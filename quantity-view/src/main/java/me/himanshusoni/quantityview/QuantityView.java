...
public class QuantityView extends LinearLayout implements View.OnClickListener {
	...
	public interface OnQuantityChangeListener {
		void onQuantityChanged(View view, int newQuantity, boolean programmatically);
		...
		if (v == mButtonAdd) {
			if (quantity + 1 > maxQuantity) {
				...
				if (onQuantityChangeListener != null)
					onQuantityChangeListener.onQuantityChanged(this, quantity, false);
			}
			...
			final View inflate = LayoutInflater.from(getContext()).inflate(me.himanshusoni.quantityview.R.layout.qv_dialog_changequantity, null, false);
	...
	public void setQuantity(int quantity) {
		...
		if (!limitReached && onQuantityChangeListener != null)
			onQuantityChangeListener.onQuantityChanged(this, quantity, true);
